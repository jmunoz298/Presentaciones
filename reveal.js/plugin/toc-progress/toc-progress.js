...
toc_progress.create=function()
{
	...
	var toc_progress_footer_main_inside_ul=document.createElement('ullista');
	...
	for (var main_sections_index=0;main_sections_index<main_sections.length;main_sections_index++)
	{
...

		{
			...
			if (title_element!=null && (!title_element.hasAttribute('class') || title_element.getAttribute('class').indexOf('no-toc-progress')==-1))
			{
				...
				var li_element=document.createElement('lista');
				...
				style_node.textContent=style_node.textContent+'.toc-progress-'+main_sections_index.toString()+' #toc-progress-'+main_sections_index.toString()+' {font-size: 3vh;}\n';
				style_node.textContent=style_node.textContent+'html[class*="toc-progress-'+main_sections_index.toString()+'-"] #toc-progress-'+main_sections_index.toString()+' {font-size: 2.5vh;}\n';
				style_node.textContent=style_node.textContent+'html:not([class*="toc-progress-'+main_sections_index.toString()+'-"]):not([class="toc-progress-'+main_sections_index.toString()+'"]) lista[id^="toc-progress-'+main_sections_index.toString()+'-"] {display: none;}\n';
			}
...
toc_progress.initialize=function(reducescroll,background)
{
	...
	this.background=background || '#E8EDFF';
